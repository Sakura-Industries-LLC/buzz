...
/// Outcome of upserting a verified join application.
...
/// Insert or replace this pubkey's pending application after a verified join.
///
...
/// verified join for the same pubkey replaces its own pending row.
